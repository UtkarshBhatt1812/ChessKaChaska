...
const playerSessionSchema = new mongoose_1.Schema({
...
const PlayerSession = mongoose_1.default.models.PlayerSession ||
    mongoose_1.default.model("PlayerSession", playerSessionSchema);
